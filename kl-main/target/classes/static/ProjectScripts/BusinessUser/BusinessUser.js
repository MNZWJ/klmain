...
$(function () {
    ...
    $.ajax({
        type: 'post',
        url: '/BusinessUser/getSysOrganiseTreeList',
        async: false,
        dataType: 'json',
    ...
    $('#userTable').bootstrapTable({
        ...
        method: 'get',//请求方式
        url: '/BusinessUser/getBusinessUserList',//请求url
    ...
    $("#btn_save").on("click", function () {
        ...
        if (bootstrapValidator.isValid()) {
            ...
            $.ajax({
                type: 'post',
                url: '/BusinessUser/updateOrAddBusinessUser',
    ...
    BootstrapDialog.confirm({
        ...
        callback: function (result) {
            if (result) {
                ...
                $.ajax({
                    type: 'post',
                    url: '/BusinessUser/deleteBusinessUser',
                    data: {ids: ids},
                    success: function (result) {
